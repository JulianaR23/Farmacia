...
public class Produto {
	...
	@Size(min = 3, max = 50, message = "O atributo nome o máximo de caracteres será de 50 e o mínimo 3!")
	private String nome;
	
	@NotNull(message = "O atributo descrição é obrigatório!")
	@Size(min = 5, max = 200, message = "O atributo nome o máximo de caracteres será de 200 e o mínimo 5!")
